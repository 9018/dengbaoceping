...
def get_history_records_summary(db: Session = Depends(get_db)):
...
def list_history_record_duplicates(
...
def delete_history_record_duplicates(
...
def list_history_record_field_values(field_name: str, db: Session = Depends(get_db)):
...
def rename_history_record_field_value(
    field_name: str,
...
def delete_history_records_by_field_value(
    field_name: str,
    value: str = Query(...),
    force: bool = Query(default=False),
    db: Session = Depends(get_db),
