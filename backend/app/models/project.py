...
class Project(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    evidence_facts = relationship("EvidenceFact", back_populates="project", cascade="all, delete-orphan")
    ...
    project_assessment_tables = relationship("ProjectAssessmentTable", back_populates="project", cascade="all, delete-orphan")
    project_assessment_items = relationship("ProjectAssessmentItem", back_populates="project", cascade="all, delete-orphan")
